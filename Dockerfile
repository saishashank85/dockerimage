...
# ------------------------------------------------------------------
    ...
    RUN curl -sL https://deb.nodesource.com/setup_16.x | bash  && \
        $APT_INSTALL nodejs  && \
        $PIP_INSTALL jupyter_contrib_nbextensions -U && \
        jupyter contrib nbextension install --user && \
        $PIP_INSTALL jupyter_nbextensions_configurator -U --user && \
        jupyter nbextensions_configurator enable --user && \
        $PIP_INSTALL category_encoders catboost optuna plotly shap imbalanced-learn 'optuna-dashboard>=0.9.0b6' explainerdashboard optuna-distributed wandb shap jupyterlab_tabnine autopep8
